...
(function () {
    ...
    // // xmlHttpObj.open("POST", "http://www.stud.fit.vutbr.cz/~xschau00/others/SEP/API/test.php", true);
    // xmlHttpObj.open("POST", "http://www.stud.fit.vutbr.cz/~xschau00/others/SEP/API/test.php?q=i_was_initialized", true);
    // // xmlHttpObj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    // // xmlHttpObj.send('q=' + encodeURIComponent(JSON.stringify(blockReport)));
    // xmlHttpObj.send();
